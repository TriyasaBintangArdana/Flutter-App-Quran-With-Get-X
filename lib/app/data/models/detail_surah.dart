...
class PreBismillah {
    ...
    factory PreBismillah.fromRawJson(String str) => PreBismillah.fromJson(json.decode(str));
...
class Transliteration {
    ...
    factory Transliteration.fromRawJson(String str) => Transliteration.fromJson(json.decode(str));
...
class Revelation {
    ...
    factory Revelation.fromRawJson(String str) => Revelation.fromJson(json.decode(str));
...
class DetailSurahTafsir {
    ...
    factory DetailSurahTafsir.fromRawJson(String str) => DetailSurahTafsir.fromJson(json.decode(str));
...
class VerseTafsir {
    ...
    factory VerseTafsir.fromRawJson(String str) => VerseTafsir.fromJson(json.decode(str));
