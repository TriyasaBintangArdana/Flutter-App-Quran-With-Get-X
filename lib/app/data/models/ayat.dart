...
class SurahTafsir {
    ...
    factory SurahTafsir.fromRawJson(String str) => SurahTafsir.fromJson(json.decode(str));
...
class AyatTafsir {
    ...
    factory AyatTafsir.fromRawJson(String str) => AyatTafsir.fromJson(json.decode(str));
